<template>
  <div class="home mt-4">
    <div class="container">
      <div class="h2 mb-2 text-center">Articles by <span class="article-author">{{ author }}</span> </div>
        ...
        <div class="card shadow p-2 mb-4 bg-body rounded">
          <div class="card-body">
            ...
            <div class="text-secondary author-font-size">
              Posted by <span class="article-author">{{ author }}</span>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async getArticles() {
      let endpoint = `/api/v1/articles/author/${this.author}/`;
      if (this.next) {
        endpoint = this.next;
      }
